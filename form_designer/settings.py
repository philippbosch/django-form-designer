...
STATIC_URL = getattr(settings, 'FORM_DESIGNER_STATIC_URL', '%sform_designer/' % settings.STATIC_URL)
...
USE_LABEL_AS_PLACEHOLDER = getattr(settings, 'FORM_DESIGNER_USE_LABEL_AS_PLACEHOLDER', False)
